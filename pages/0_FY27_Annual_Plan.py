...
# ================================================================
# SECTION 2 — SAME-CITY EXPANSION (Capacity Saturation)
# ================================================================
st.divider()
st.markdown(f'<p class="section-header">2️⃣ SAME-CITY EXPANSION — Clinics at Capacity (≥{ntb_threshold} NTB Shows/Month)</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 3 — NTB:POPULATION RATIO ENGINE
# ================================================================
st.divider()
st.markdown('<p class="section-header">3️⃣ NTB:POPULATION RATIO — The Projection Anchor</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 4 — NEW CITY EXPANSION (Demand-Validated)
# ================================================================
st.divider()
st.markdown('<p class="section-header">4️⃣ NEW CITY EXPANSION — Demand-Validated, Ratio-Projected</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 5 — SHOW% FIX BEFORE EXPANSION
# ================================================================
st.divider()
st.markdown('<p class="section-header">5️⃣ FIX BEFORE EXPAND — ₹0 CAC Revenue Unlock</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 5B — UNIT ECONOMICS (Actual Cost Structure)
# ================================================================
st.divider()
...
# ================================================================
# SECTION 6 — FY27 REVENUE PROJECTION (Ratio-Adjusted)
# ================================================================
st.divider()
st.markdown('<p class="section-header">6️⃣ FY27 REVENUE PROJECTION — Ratio-Adjusted, Scenario-Tested</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 7 — RISK-ADJUSTED EXPANSION SCORECARD
# ================================================================
st.divider()
st.markdown('<p class="section-header">7️⃣ RISK SCORECARD — What Could Go Wrong (and How We\'ll Know)</p>',
            unsafe_allow_html=True)
...
# ================================================================
# SECTION 8 — SCENARIO MATRIX (renumbered from 7)
# ================================================================
st.divider()
st.markdown('<p class="section-header">8️⃣ SCENARIO COMPARISON — Three Outcomes for the Board</p>',
            unsafe_allow_html=True)
...
# ================================================================
st.divider()
st.markdown('<p class="section-header">9️⃣ THE ASK — FY27 Expansion Decision Framework</p>',
            unsafe_allow_html=True)
